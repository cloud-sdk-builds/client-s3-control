...
[`@aws-sdk/client-s3-control`](https://www.npmjs.com/package/@aws-sdk/client-s3-control/v/3.975.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3-control@3.975.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PGW8KhdFig4veSPto+/ts0KGCMOwKKhJeHjZ/N6StmSHjwIw8XchwCluNs6a1/7v
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-s3-control": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3-control@3.975.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3-control@3.975.0/index.min.mjs": "sha384-PGW8KhdFig4veSPto+/ts0KGCMOwKKhJeHjZ/N6StmSHjwIw8XchwCluNs6a1/7v"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-s3-control/blob/refs/tags/3.975.0/LICENSE
```
