...
[`@aws-sdk/client-s3-control`](https://www.npmjs.com/package/@aws-sdk/client-s3-control/v/3.202.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3-control@3.202.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TAH477p5zKdjekYQ4P6ZVIcdHRxHTImJB2k3kAPWWHGZesVVea7Dz+VAGwp5ipCm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-s3-control": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3-control@3.202.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3-control@3.202.0/index.min.mjs": "sha384-TAH477p5zKdjekYQ4P6ZVIcdHRxHTImJB2k3kAPWWHGZesVVea7Dz+VAGwp5ipCm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-s3-control/blob/refs/tags/3.202.0/LICENSE
```
